...
# female_LEAT_model = tf.keras.models.load_model('static/models/Life_expectancy_at_birth(female)/Life_expectancy_at_birth(female)_model.h5')
...
# male_LEAT_model = tf.keras.models.load_model('static/models/Life_expectancy_at_birth(male)/Life_expectancy_at_birth(male)_model.h5')
